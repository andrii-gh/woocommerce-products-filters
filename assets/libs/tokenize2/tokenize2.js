...
(function(factory){
    ...
    Tokenize2.prototype.init = function(){
        ...
        this.input = $(`<input placeholder="${this.options.inputPlaceholder}" autocomplete="off" />`)
    ...
    Tokenize2.prototype.dropdownMove = function(){
        ...
        const $searchInput = this.tokensContainer.find('.token-search > input');
        const searchInputHeight = $searchInput.outerHeight();

        this.dropdown.css({
            top: $position.top + searchInputHeight + 3,
            // top: $position.top,
