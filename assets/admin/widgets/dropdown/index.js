jQuery(function ($) {
    ...
    function init() {
        ...
        $(document).on('plugin-wpf-admin-saved-widget-dropdown', saveWidget);
    }

    function saveWidget() {
        const widget = $(arguments[1]);
        const selectElement = widget.find('[data-pwpf-select][data-pwpf-widget-dropdown]');

        selectElement.selectize();
    }

    function initWidget() {
        $('[data-pwpf-select][data-pwpf-widget-dropdown]').selectize();
    }
    ...
    function processBackendUpdatedWidget(event, XMLHttpRequest, ajaxOptions) {
        ...
        const widgetBase = pluginWoocommerceProductsFiltersWidgetDropdown.widgetName;
        ...
        !XMLHttpRequest.responseText
            ...
            : $(document).trigger('plugin-wpf-admin-saved-widget-dropdown', widget);
    }
});