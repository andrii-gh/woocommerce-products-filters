jQuery(function ($) {
    ...
    function init() {
        ...
        $(document).on('plugin-wpf-admin-saved-widget-checkbox', saveWidget);
    }

    function saveWidget() {
        const widget = $(arguments[1]);
        const selectElement = widget.find('[data-pwpf-select][data-pwpf-widget-checkbox]');

        selectElement.selectize();
    }

    function initWidget() {
        $('[data-pwpf-select][data-pwpf-widget-checkbox]').selectize();
    }
    ...
    function processBackendUpdatedWidget(event, XMLHttpRequest, ajaxOptions) {
        ...
        const widgetBase = pluginWoocommerceProductsFiltersWidgetCheckbox.widgetName;
        ...
        !XMLHttpRequest.responseText
            ...
            : $(document).trigger('plugin-wpf-admin-saved-widget-checkbox', widget);
    }
});