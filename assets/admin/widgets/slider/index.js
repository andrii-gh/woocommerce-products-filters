jQuery(function ($) {
    ...
    function init() {
        ...
        $(document).on('plugin-wpf-admin-saved-widget-slider', saveWidget);
    }

    function saveWidget() {
        const widget = $(arguments[1]);
        const selectElement = widget.find('[data-pwpf-select][data-pwpf-widget-slider]');

        selectElement.selectize();
    }

    function initWidget() {
        $('[data-pwpf-select][data-pwpf-widget-slider]').selectize();
    }
    ...
    function processBackendUpdatedWidget(event, XMLHttpRequest, ajaxOptions) {
        ...
        const widgetBase = pluginWoocommerceProductsFiltersWidgetSlider.widgetName;
        ...
        !XMLHttpRequest.responseText
            ...
            : $(document).trigger('plugin-wpf-admin-saved-widget-slider', widget);
    }
});