<div class="pwpf-accordion pwpf-accordion_theme-default">
	...
	<div
		...
		<div data-pwpf-search-dropdown="<?php echo esc_attr( $this->view_data->attribute['id'] ) ?>" class="pwpf-dropdown pwpf-dropdown_theme--default">
			<select multiple="multiple"
					data-pwpf-search-dropdown-placeholder="<?php echo esc_attr( $this->view_data->placeholder ) ?>"
					data-pwpf-search-dropdown-select="<?php echo esc_attr( $this->view_data->attribute['id'] ) ?>">
			</select>
		</div>
		<?php if ( false ) { ?>
			<?php foreach ( $this->view_data->options as $option ) { ?>
				<label class="pwpf-widget-checkbox-checkbox__item pwpf-widget-checkbox-checkbox__item_theme-default">
					<input
						...
						type="checkbox"
						data-pwpf-option-id="<?php esc_attr_e( $option['id'] ) ?>"
						data-mfp-attribute-slug="<?php esc_attr_e( $this->view_data->attribute['slug'] ) ?>">
					<span class="
