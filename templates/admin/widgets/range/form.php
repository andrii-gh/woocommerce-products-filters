...
<div class="pwpf-admin-widget">
	...
	<label class="pwpf-admin-widget-label pwpf-admin-widget-label_theme_pwpf">
		<select
				...
				data-pwpf-widget-range="widget-id"
	...
	<label class="pwpf-admin-widget-label pwpf-admin-widget-label_theme_pwpf">
		<input
			autocomplete="off"
			name="<?php esc_attr_e( $this->view_data->widget->get_field_name( 'name' ) ) ?>"
			value="<?php esc_attr_e( $this->view_data->data['name'] ) ?>"
			class="pwpf-admin-widget-input-text pwpf-admin-widget-input-text_type_normal">
	</label>

	<p class="pwpf-admin-widget-item-title pwpf-admin-widget-item-title_theme_pwpf">
		<?php Translator::esc_html_ex( 'Title (From)', 'Widget' ) ?>
	</p>
	<label class="pwpf-admin-widget-label pwpf-admin-widget-label_theme_pwpf">
		<input
				autocomplete="off"
				name="<?php esc_attr_e( $this->view_data->widget->get_field_name( 'title-from' ) ) ?>"
				value="<?php esc_attr_e( $this->view_data->data['title-to'] ) ?>"
				class="pwpf-admin-widget-input-text pwpf-admin-widget-input-text_type_normal">
	</label>

	<p class="pwpf-admin-widget-item-title pwpf-admin-widget-item-title_theme_pwpf">
		<?php Translator::esc_html_ex( 'Title (To)', 'Widget' ) ?>
	</p>
	<label class="pwpf-admin-widget-label pwpf-admin-widget-label_theme_pwpf">
		<input
				autocomplete="off"
				name="<?php esc_attr_e( $this->view_data->widget->get_field_name( 'title-to' ) ) ?>"
				value="<?php esc_attr_e( $this->view_data->data['title-to'] ); ?>"
				class="pwpf-admin-widget-input-text pwpf-admin-widget-input-text_type_normal">
	</label>
</div>